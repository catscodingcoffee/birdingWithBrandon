...
// Public site key. Falls back to Cloudflare's "always passes" test key for local
// dev — set NEXT_PUBLIC_TURNSTILE_SITE_KEY to the real key in .env.local and on DO.
  ...
  return (
    <div className="space-y-8">
        ...
        <form onSubmit={mode==="login"?handleLogin:handleSignup} className="flex flex-col gap-3">
            ...
            <button
              type="submit"
              disabled={loading || !email.trim() || !password.trim() || !captchaToken}
